...
function changeBackground(imageUrl) {
    var jumboElements = document.getElementsByClassName('jumbo');
    
    // Loop through each element with the class 'jumbo'
    for (var i = 0; i < jumboElements.length; i++) {
        // Set the background image for each 'jumbo' element
        jumboElements[i].style.backgroundImage = 'url(' + imageUrl + ')';
    }
}